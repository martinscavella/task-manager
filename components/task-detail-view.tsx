...
import { TaskWorkflowTimeline } from './task-workflow-timeline'
...
export function TaskDetailView({ task }: TaskDetailViewProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      {/* RIGHT col (1/3): workflow timeline */}
      <div className="lg:col-span-1">
        <div className="border rounded-lg p-4 sticky top-6">
          <h2 className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-4">Workflow</h2>
          <TaskWorkflowTimeline task={task} />
        </div>
      </div>
